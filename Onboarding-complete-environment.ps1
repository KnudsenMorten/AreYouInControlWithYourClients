...
#------------------------------------------------------------------------------------------------------------
  ...
  # DEMO
    ...
    # Azure App
    $AzureAppName                          = "Demo2 - Automation - Log-Ingestion"
    ...
    $WorkBook_Repository_Path              = "$($Env:OneDrive)\SCRIPTS_REPOSITORY\SCRIPTS-AUTOMATION\AZURE_WORKBOOKS_LATEST_RELEASE_V2\WORKBOOKS_LATEST_RELEASE"
    $Dashboard_Repository_Path             = "$($Env:OneDrive)\SCRIPTS_REPOSITORY\SCRIPTS-AUTOMATION\AZURE_DASHBOARDS_LATEST_RELEASE_v2"
    

#----------
<#
    # DEMO100
    $AzureAppName                          = "Demo100 - Automation - Log-Ingestion"
    $TenantId                              = "f0fa27a0-8e7c-4f63-9a77-ec94786b7c9e"

    $LogAnalyticsSubscription              = "fce4f282-fcc6-43fb-94d8-bf1701b862c3"
    $LogAnalyticsResourceGroup             = "rg-logworkspaces"
    $LoganalyticsWorkspaceName             = "log-platform-management-client-demo100-p"
    $LoganalyticsLocation                  = "westeurope"
